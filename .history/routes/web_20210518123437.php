...
Route::group(['prefix' => 'admin'], function () {
    Route::get('login', 'AdminControllers\LoginController@initContent')->name('admin.logout');
    Route::post('login', 'AdminControllers\LoginController@login')->name('post.adminlogin');
    Route::get('logout', 'AdminControllers\LoginController@logout')->name('admin.logout');
